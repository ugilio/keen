...
import it.cnr.istc.keen.ui.refactoring.DdlRefactoringCrossReferenceSerializer.RefTextEvaluator;
...
public class DdlReferenceUpdater extends AbstractReferenceUpdater {

	private static final Logger log = Logger.getLogger(DdlReferenceUpdater.class);
	 ...
	 */
	@Inject
	private DdlRefactoringCrossReferenceSerializer crossReferenceSerializer;
