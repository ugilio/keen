...
public class DdlRefactoringCrossReferenceSerializer {

	private static final Logger log = Logger.getLogger(DdlRefactoringCrossReferenceSerializer.class);
