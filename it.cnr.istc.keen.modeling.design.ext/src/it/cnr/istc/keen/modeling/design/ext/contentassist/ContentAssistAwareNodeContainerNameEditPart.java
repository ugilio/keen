...
public class ContentAssistAwareNodeContainerNameEditPart extends DNodeContainerNameEditPart {

	public ContentAssistAwareNodeContainerNameEditPart(View view) {
		super(view);
	}
